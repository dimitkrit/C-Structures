...
σε αύξουσα διάταξη και στη συνέχεια θα εμφανίζεται το πλήθος των φύλλων του ΔΔΑ στο κυρίως πρόγραμμα. Δίνεται ένα
...
// Στο ΔΔΑ θα καταχωρούνται ακέραιοι
   CreateBST(&ARoot);
   do{
...
// Θα εμφανίζονται οι κόμβοι του ΔΔΑ σε αύξουσα διάταξη
   printf("Elements of BST\n");
   RecBSTInorder(ARoot);
//θα εμφανίζεται το πλήθος των φύλλων του ΔΔΑ στο κυρίως πρόγραμμα
...
/* θα υπολογίζει το πλήθος των
φύλλων ενός ΔΔΑ το οποίο και θα επιστρέφει*/
